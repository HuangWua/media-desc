...
| Hand Pose | 需要手部在画面中足够大 | 远处手势检测不到 |
| 英文 TTS 识别 | TTS 合成语音缺自然停顿 | 真人录音无此问题 |
| 歌声识别 | Speech 框架优化目标为说话 | 音乐歌词识别率 ~60% |
| Aesthetics 子分数 | blur/exposure 在 macOS 26 API 中不暴露 | 仅 overall 分数有效 |
| 视频无音轨 | 画面文字语言可能为 unknown | 需要足够多的帧 OCR 文本才能检测 |
